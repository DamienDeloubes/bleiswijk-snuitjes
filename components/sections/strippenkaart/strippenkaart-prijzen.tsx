export const StrippenkaartPrijzen = () => {
  return (
    <section
        ...
        <div className="section_title text-center mb-2">
          <div className="row justify-content-center">
            <div className="col col-lg-5">
              ...
              <p className="mb-0">
                Een goedkopere optie voor vaste klanten die regelmatig gebruik
                willen maken van mijn diensten.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="services_price_items_wrap">
              <div className="service_price_item">
                <div className="item_image">
                  <img
                    ...
                    alt="Oppashond wordt 10x uitgelaten"
                  />
                </div>
              ...
              <div className="service_price_item">
                <div className="item_image">
                  <img
                    src="/images/gallery/oppashond-pommeraan-wordt-uitgelaten.jpg"
                    alt="Oppashond wordt 15x uitgelaten"
                  />
                </div>
                <div className="item_content">
                  <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="service_price_item">
                <div className="item_image">
                  <img
                    src="/images/gallery/oppashond-pommeraan-wordt-uitgelaten.jpg"
                    alt="Oppashond wordt 20x uitgelaten"
                  />
                </div>
                <div className="item_content">
                  <div className="d-flex justify-content-between align-items-center">
