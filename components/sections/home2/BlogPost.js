  ...
  <section className="blog_section section_space_md">
    <div className="container">
      <div className="section_title text-center">
        <h2 className="title_text mb-0"><span className="sub_title">Our Blog</span> Tatest Post</h2>
      </div>
      ...
      <div className="row justify-content-center">
        <div className="col col-lg-4 col-md-6 col-sm-6">
          <div className="blog_item">
            ...
            <Link className="item_image" href="news-details"><img src="/images/blog/blog_image_1.jpg" alt="Pet Care Image"/></Link>
        ...
        <div className="col col-lg-4 col-md-6 col-sm-6">
          <div className="blog_item">
            ...
            <Link className="item_image" href="news-details"><img src="/images/blog/blog_image_2.jpg" alt="Pet Care Image"/></Link>
            <div className="item_content">
              <ul className="post_meta unorder_list">
                <li><Link href="#!"><i className="fas fa-user"></i> by Corabelle Durrad</Link></li>
                <li><Link href="#!"><i className="fas fa-calendar-day"></i> 02.01.2022</Link></li>
        ...
        <div className="col col-lg-4 col-md-6 col-sm-6">
          <div className="blog_item">
            ...
            <Link className="item_image" href="news-details"><img src="/images/blog/blog_image_3.jpg" alt="Pet Care Image"/></Link>
            <div className="item_content">
              <ul className="post_meta unorder_list">
                <li><Link href="#!"><i className="fas fa-user"></i> by Corabelle Durrad</Link></li>
                <li><Link href="#!"><i className="fas fa-calendar-day"></i> 02.01.2022</Link></li>
