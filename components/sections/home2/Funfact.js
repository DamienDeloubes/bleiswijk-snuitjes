...
const Funfact = () => {
  ...
  <section className="funfact_section section_space_md">
    <div className="container">
      <div className="funfact_wrapper decoration_wrap" style={{ backgroundImage: 'url(images/overlay/shapes_overlay_3.svg)' }}>
        <div className="section_overlay" style={{ backgroundImage: 'url(images/overlay/shapes_overlay_4.svg)' }}></div>
