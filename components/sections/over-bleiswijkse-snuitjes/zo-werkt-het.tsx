            ...
            <div className="col col-lg-3 col-md-6 col-sm-6">
              <div className="iconbox_item iconbox_centericon">
                ...
                <div className="item_content">
                  <h3 className="item_title">Kennismaking</h3>
                  <p className="mb-0">
                    We plannen een kort bezoek bij jou thuis om jouw hond,
                    routines en wensen te leren kennen.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col col-lg-3 col-md-6 col-sm-6">
              <div className="iconbox_item iconbox_centericon">
                ...
                <div className="item_content">
                  ...
                  <p className="mb-0">
                    Samen stemmen we af wanneer de wandelingen, oppas of
                    thuisbezoeken plaatsvinden.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col col-lg-3 col-md-6 col-sm-6">
              <div className="iconbox_item iconbox_centericon">
                ...
                <div className="item_content">
                  ...
                  <p className="mb-0">
                    Elke wandeling of opvang is individueel, zodat jouw hond
                    alle aandacht krijgt en zich veilig voelt.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col col-lg-3 col-md-6 col-sm-6">
              <div className="iconbox_item iconbox_centericon">
                ...
                <div className="item_content">
                  ...
                  <p className="mb-0">
                    Je ontvangt foto's, korte updates en tips, zodat je altijd
                    weet hoe het gaat.
                  </p>
                </div>
              </div>
