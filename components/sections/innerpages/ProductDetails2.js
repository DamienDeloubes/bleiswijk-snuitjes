        ...
        <Swiper {...swiperOptions} className=" common_carousel_4col">
          ...
          <SwiperSlide className="carousel_item">
            <div className="product_item">
              ...
              <div className="item_image">
                <Link className="image_wrap" href="shop-details">
                  <img src="/images/shop/product_img_2.jpg" alt="Squeezz Ball Dog Toy"/>
                </Link>
                <ul className="cart_btns_group">
                  <li><Link href="#!">Add To Cart</Link></li>
                  <li><Link href="#!"><i className="far fa-heart"></i></Link></li>
              ...
              <div className="item_content">
                <h3 className="item_title">
                  <Link href="shop-details">Squeezz Ball Dog Toy</Link>
                </h3>
                <ul className="rating_star">
                  <li><i className="fas fa-star"></i></li>
                  <li><i className="fas fa-star"></i></li>
          ...
          <SwiperSlide className="carousel_item">
            <div className="product_item">
              <div className="item_image">
                <Link className="image_wrap" href="shop-details">
                  <img src="/images/shop/product_img_3.jpg" alt="Hydrolyzed Dry Dog Food"/>
                </Link>
                <ul className="cart_btns_group">
                  <li><Link href="#!">Add To Cart</Link></li>
                  <li><Link href="#!"><i className="far fa-heart"></i></Link></li>
              ...
              <div className="item_content">
                <h3 className="item_title">
                  <Link href="shop-details">Hydrolyzed Dry Dog Food</Link>
                </h3>
                <ul className="rating_star">
                  <li><i className="fas fa-star"></i></li>
                  <li><i className="fas fa-star"></i></li>
          ...
          <SwiperSlide className="carousel_item">
            <div className="product_item">
              <div className="item_image">
                <Link className="image_wrap" href="shop-details">
                  <img src="/images/shop/product_img_4.jpg" alt="Flying Fish Cat Scratching "/>
                </Link>
                <ul className="cart_btns_group">
                  <li><Link href="#!">Add To Cart</Link></li>
                  <li><Link href="#!"><i className="far fa-heart"></i></Link></li>
          ...
          <SwiperSlide className="carousel_item">
            <div className="product_item">
              <div className="item_image">
                <Link className="image_wrap" href="shop-details">
                  <img src="/images/shop/product_img_5.jpg" alt="Tug Dog Toy"/>
                </Link>
                <ul className="cart_btns_group">
                  <li><Link href="#!">Add To Cart</Link></li>
                  <li><Link href="#!"><i className="far fa-heart"></i></Link></li>
              ...
              <div className="item_content">
                <h3 className="item_title">
                  <Link href="shop-details">Tug Dog Toy</Link>
                </h3>
                <ul className="rating_star">
                  <li><i className="fas fa-star"></i></li>
                  <li><i className="fas fa-star"></i></li>
