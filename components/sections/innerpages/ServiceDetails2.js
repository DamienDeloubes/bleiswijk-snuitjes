  ...
  <section className="service_details_section section_space_lg">
    <div className="container">
      ...
      <div className="video_wrapper text-center" style={{ backgroundImage: 'url(/images/video/video_poster_image_2-min.jpg)' }}>
        <a onClick={() => setOpen(true)} className="video_play_btn popup_video"><i className="fa-duotone fa-play" /></a> 
      </div>
              ...
              <div className="col-lg-6">
                <div className="d-lg-flex text-lg-start justify-content-lg-start text-center justify-content-center align-items-center">
                  <div className="author_image">
                    <img src="/images/meta/author_image_3-min.png" alt="Talking Minds - Psychotherapist React NextJs Template" />
                  </div>
    ...
    <div className="container">
      ...
      <div className="row justify-content-center">
        <div className="col-lg-4 col-md-6 col-sm-6">
          <div className="service_item">
            <div className="item_icon">
              <img src="/images/icons/icon_brain.svg" alt="Brain Icon - Talking Minds – Psychotherapist React NextJs Template" />
            </div>
        ...
        <div className="col-lg-4 col-md-6 col-sm-6">
          <div className="service_item">
            <div className="item_icon">
              <img src="/images/icons/icon_head_double.svg" alt="Head Double Icon - Talking Minds – Psychotherapist React NextJs Template" />
            </div>
            <div className="item_contact">
        ...
        <div className="col-lg-4 col-md-6 col-sm-6">
          <div className="service_item">
            <div className="item_icon">
              <img src="/images/icons/icon_head.svg" alt="Brain Icon - Talking Minds – Psychotherapist React NextJs Template" />
            </div>
            <div className="item_contact">
      ...
      <div className="btn_wrap pb-0 text-center">
        <Link className="btn btn-primary" href="page-service">
    ...
    <div className="container">
      <div className="consultation_form bg_primary_light decoration_wrapper">
        ...
        <div className="decoration_item shape_leaf_1">
          <img src="/images/shapes/shape_leaf_right_top.svg" alt="Shape Leaf - Talking Minds - Psychotherapist React NextJs Template" />
        </div>
        <div className="decoration_item shape_leaf_2">
          <img src="/images/shapes/shape_leaf_left_bottom.svg" alt="Shape Leaf - Talking Minds - Psychotherapist React NextJs Template" />
        </div>
      </div>
    </div>
  </section>
