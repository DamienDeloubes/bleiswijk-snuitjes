...
const Banner = () => {
  ...
  <section className="banner_section banner_style_1 decoration_wrap" style={{ backgroundImage: 'url(images/background/shape_bg_1_1.png)' }}>
    {/* <div className="section_overlay" style={{ backgroundImage: 'url(images/overlay/shapes_overlay_1.svg)' }}></div> */}
    <div className="container">
      <div className="banner_content">
        <h1 className="banner_title">Met liefde en zorg voor jouw viervoeter in Bleiswijk</h1>
        <p className="banner_description">
          Bij Bleiswijkse Snuitjes krijgt jouw trouwe viervoeter de wandelingen en oppas die hij verdient. Flexibel, persoonlijk en helemaal afgestemd op jullie wensen.
        </p>
