            ...
            <div className="gallery_item">
              <div className="item_image">
                <img
                  ...
                  alt="Oppashonden worden uitgelaten"
                />
              </div>
              <Link className="item_content" href="/diensten">
                <span className="d-block">
                  <small>Bekijk diensten</small>
                </span>
                <strong className="d-block">
                  Opvang, uitlaten en verzorging
                </strong>
              </Link>
            </div>
          </div>
            ...
            <div className="gallery_item">
              <div className="item_image">
                <img
                  ...
                  alt="Oppashond luistert naar zit commando"
                />
              </div>
              <Link className="item_content" href="/diensten">
                <span className="d-block">
            ...
            <div className="gallery_item">
              <div className="item_image">
                <img
                  ...
                  alt="Oppashond zit gezellig op de bank"
                />
              </div>
              <Link className="item_content" href="/diensten">
                <span className="d-block">
            ...
            <div className="gallery_item">
              <div className="item_image">
                <img
                  ...
                  alt="Oppashond kijkt naar vertrekkende watertaxi tijdens uitlaten"
                />
              </div>
              <Link className="item_content" href="/diensten">
                <span className="d-block">
            ...
            <div className="gallery_item">
              <div className="item_image">
                <img
                  ...
                  alt="Oppashond wordt uitgelaten terwijl hij stok in zijn mond heeft"
                />
              </div>
              <Link className="item_content" href="/diensten">
                <span className="d-block">
