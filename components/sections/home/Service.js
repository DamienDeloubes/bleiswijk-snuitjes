  ...
  <section className="service_section section_space_lg pb-0">
    <div className="container">
      ...
      <div className="section_title text-center">
        <h2 className="title_text mb-0"><span className="sub_title">Our Services</span> All Pet Care Services</h2>
      </div>
      ...
      <div className="row justify-content-center">
        ...
        <div className="col col-lg-4 col-sm-6">
          <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
            <div className="title_wrap">
              <div className="item_icon">
              <img src="/images/icon/icon_pet_grooming.svg" alt="Pet Grooming"/>
              </div>
        ...
        <div className="col col-lg-4 col-sm-6">
          <div className="service_item" style={{ backgroundImage: 'url(images/shape/shape_path_1.svg)' }}>
            <div className="title_wrap">
              <div className="item_icon">
              <img src="/images/icon/icon_pet_training.svg" alt="Pet Training"/>
              </div>
