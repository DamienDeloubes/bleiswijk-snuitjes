          ...
          <div className="row align-items-center justify-content-lg-between">
            <div className="col col-lg-5">
              <div className="section_title">
                ...
                <p>
                  Regelmatige wandelingen? Met een strippenkaart ben je
                  verzekerd van vaste momenten en een voordeliger tarief per
                  keer.
                </p>
              </div>
              ...
              <div className="mt-5 cta-container">
                <Link href="/strippenkaart" className="btn btn_primary">
                  Bekijk strippenkaart
                </Link>
              </div>
            </div>
