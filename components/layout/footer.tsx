                ...
                <div className="footer_widget mb50-sm">
                  ...
                  <div className="page_list">
                    <ul className="unorder_list_block">
                      <li>
                        <Link href="/">
                          <i className="fas fa-circle"></i>Startpagina
                        </Link>
                      </li>
                      <li>
                        <Link href="/diensten">
                          <i className="fas fa-circle"></i>Diensten & Prijzen
                        </Link>
                      </li>
                      <li>
                        <Link href="/over-bleiswijkse-snuitjes">
                          <i className="fas fa-circle"></i>Over Bleiswijkse
                          Snuitjes
                        </Link>
                      </li>
                      <li>
                        <Link href="/contact">
                          <i className="fas fa-circle"></i>Contact
                        </Link>
                      </li>
                    </ul>
                  </div>
